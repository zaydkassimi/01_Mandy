...
"[project]/pages/api/export_xlsx.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (type === "users") {
        rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["listUsers"])();
        filename = "users.xlsx";
    } else if (type === "attendances") {
        rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getAllAttendances"])();
        filename = "attendances.xlsx";
    } else if (type === "shifts") {
        rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["listShifts"])();
        filename = "shifts.xlsx";
    } else if (type === "expenses") {
        rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["listExpenses"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f74b7fc._.js.map