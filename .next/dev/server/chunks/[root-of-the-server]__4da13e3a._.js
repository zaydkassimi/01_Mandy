...
async function handler(req, res) {
    ...
    if (req.method === "GET") {
        const expenses = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["listExpenses"])();
        return res.json({
            ok: true,
            expenses
        });
    ...
    if (req.method === "POST") {
        ...
        if (!date || amount == null) return res.status(400).json({
            ok: false,
            message: "date & amount required"
        });
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["addExpense"])(exp);
        return res.json({
            ok: true,
            expense: exp
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4da13e3a._.js.map