...
"[project]/pages/api/export.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (type === "users") {
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["listUsers"])();
    ...
    if (type === "attendances") {
        const attends = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getAllAttendances"])();
    ...
    if (type === "expenses") {
        const exp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["listExpenses"])();
        const csv = toCSV(exp, [
            "id",
            "date",
            "amount",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f3a8f38._.js.map