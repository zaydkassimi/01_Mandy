...
async function handler(req, res) {
    ...
    if (req.method === "POST") {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["addUser"])({
            email,
            password,
            role: role || "employee"
        });
    ...
    if (req.method === "DELETE") {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteUserByEmail"])(email);
        return res.json({
            ok: true
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adfdcff1._.js.map