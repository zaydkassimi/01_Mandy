...
"[project]/pages/api/admin/availability.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method === "GET") {
        const list = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getAllAvailabilities"])();
        return res.json({
            ok: true,
            availabilities: list
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e460758._.js.map