...
"[project]/pages/admin/shifts.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminShifts({ user }) {
    ...
    const [start, setStart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [end, setEnd] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [capacity, setCapacity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminShifts.useEffect": ()=>{
            fetch("/api/admin/shifts").then({
                "AdminShifts.useEffect": (r)=>r.json()
            }["AdminShifts.useEffect"]).then({
                "AdminShifts.useEffect": (d)=>{
                    if (d.ok) setShifts(d.shifts || []);
                }
            }["AdminShifts.useEffect"]);
            fetch("/api/admin/availability").then({
                "AdminShifts.useEffect": (r)=>r.json()
            }["AdminShifts.useEffect"]).then({
                "AdminShifts.useEffect": (d)=>{
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    availabilities.filter((a)=>a.date === s.date).map((a)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                            value: a.email,
                                                                            children: a.email
                                                                        }, a.email, false, {
                                                                            fileName: "[project]/pages/admin/shifts.js",
...
_s(AdminShifts, "rlE9VvhBgaz4aTIt6K436QERSVs=");
_c = AdminShifts;
var _c;
__turbopack_context__.k.register(_c, "AdminShifts");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/admin/shifts.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/admin/shifts";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/admin/shifts.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/pages/admin/shifts.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/admin/shifts.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__966df4a0._.js.map