...
"[project]/pages/checkin.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CheckInPage({ user }) {
    _s();
    const videoRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRef"])();
    const canvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRef"])();
        ...
        "CheckInPage.useEffect": ()=>{
            ...
            async function start() {
                try {
                    ...
                    if (!mounted) {
                        s.getTracks().forEach({
                            "CheckInPage.useEffect.start": (t)=>t.stop()
                        }["CheckInPage.useEffect.start"]);
                        return;
                    }
                    setStream(s);
                ...
                "CheckInPage.useEffect": ()=>{
                    ...
                    if (stream) {
                        stream.getTracks().forEach({
                            "CheckInPage.useEffect": (t)=>t.stop()
                        }["CheckInPage.useEffect"]);
                    }
                }
            })["CheckInPage.useEffect"];
...
_s(CheckInPage, "xH9xhrQ7q2g/mxojimiqx15EMX8=");
_c = CheckInPage;
var _c;
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/checkin.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/checkin";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/checkin.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/pages/checkin\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/checkin.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__83173e6a._.js.map